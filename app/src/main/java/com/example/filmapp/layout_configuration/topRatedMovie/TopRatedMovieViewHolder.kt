...
class TopRatedMovieViewHolder(inflater: LayoutInflater, parent: ViewGroup, val listener: TopRatedMovieRecycleViewClickListener):
    ...
    override fun onClick(v: View?) {
        ...
        if (position != RecyclerView.NO_POSITION){
            listener.onTopRatedItemClicked(position)
        }
    }
}